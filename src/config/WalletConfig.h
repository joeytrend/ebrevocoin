...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "ebrv";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "EBR";
    ...
    const std::string daemonName = "ebrd";

    /* The name to call this wallet */
    const std::string walletName = "ebr-wallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "ebr-service";
